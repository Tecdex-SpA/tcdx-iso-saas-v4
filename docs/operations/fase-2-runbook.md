...
retries. Antes de full se ejecutan las ocho pruebas stateful de Fase 1 con el
mismo manifest, preservando su contrato de idempotencia; las cinco vistas se
reservan para full. La pasada full incluye las 30 pruebas de Fase 1 y las 16 de
Fase 2.
