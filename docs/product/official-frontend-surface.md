...
| `/ia` | `frontend/src/app/ia/page.tsx` | legacy_candidate | No | Interno/platform por guard oculto | ai | Recomendaciones legacy sobre controles; su contrato no tiene paridad demostrada en IA Compliance. | `blocked_pending_mvp_merge`; migrar o retirar valor faltante antes de cuarentena. |
