...
| `/acciones-recomendadas` | `frontend/src/app/acciones-recomendadas/page.tsx` | functional_mvp_subflow | No | Admin, auditor, area owner | action_plans.functional_subflows.read | Subflujo enlazado desde `/planes-accion`; no es item principal del sidebar. | Mantener como subflujo controlado. |
| `/activos` | `frontend/src/app/activos/page.tsx` | functional_mvp_subflow | No | Admin, auditor, area owner | risks.functional_subflows.read | Subflujo enlazado desde `/riesgos`; no es item principal del sidebar. | Mantener como subflujo controlado. |
...
| `/auditorias` | `frontend/src/app/auditorias/page.tsx` | functional_mvp_subflow | No | Admin, auditor, area owner | compliance.functional_subflows.read | Subflujo enlazado desde `/cumplimiento-auditoria`; no es item principal del sidebar. | Mantener como subflujo controlado. |
...
| `/ciclo-vida` | `frontend/src/app/ciclo-vida/page.tsx` | functional_mvp_subflow | No | Admin, auditor, area owner | compliance.functional_subflows.read | Subflujo enlazado desde `/cumplimiento-auditoria`; no es item principal del sidebar. | Mantener como subflujo controlado. |
...
| `/controles` | `frontend/src/app/controles/page.tsx` | functional_mvp_subflow | No | Admin, auditor, area owner | compliance.functional_subflows.read | Subflujo enlazado desde `/cumplimiento-auditoria`; no es item principal del sidebar. | Mantener como subflujo controlado. |
...
| `/hallazgos` | `frontend/src/app/hallazgos/page.tsx` | functional_mvp_subflow | No | Admin, auditor, area owner | compliance.functional_subflows.read | Subflujo enlazado desde `/cumplimiento-auditoria`; no es item principal del sidebar. | Mantener como subflujo controlado. |
| `/health` | `frontend/src/app/health/page.tsx` | functional_mvp_subflow | No | Admin, auditor, area owner | compliance.functional_subflows.read | Subflujo de salud enlazado desde `/cumplimiento-auditoria`; no es item principal del sidebar. | Mantener como subflujo controlado. |
...
| `/matriz-riesgo` | `frontend/src/app/matriz-riesgo/page.tsx` | functional_mvp_subflow | No | Admin, auditor, area owner | risks.functional_subflows.read | Subflujo enlazado desde `/riesgos`; no es item principal del sidebar. | Mantener como subflujo controlado. |
| `/no-conformidades` | `frontend/src/app/no-conformidades/page.tsx` | functional_mvp_subflow | No | Admin, auditor, area owner | compliance.functional_subflows.read | Subflujo enlazado desde `/cumplimiento-auditoria`; no es item principal del sidebar. | Mantener como subflujo controlado. |
...
| `/plan-accion` | `frontend/src/app/plan-accion/page.tsx` | functional_mvp_subflow | No | Admin, auditor, area owner | action_plans.functional_subflows.read | Subflujo enlazado desde `/planes-accion`; no es item principal del sidebar. | Mantener como subflujo controlado. |
...
| `/soa` | `frontend/src/app/soa/page.tsx` | functional_mvp_subflow | No | Admin, auditor, area owner | compliance.functional_subflows.read | Subflujo enlazado desde `/cumplimiento-auditoria`; no es item principal del sidebar. | Mantener como subflujo controlado. |
...
Las 10 rutas oficiales son la navegacion principal MVP. Las vistas internas
marcadas como `functional_mvp_subflow` son accesibles desde tarjetas de modulos
MVP para roles tenant operativos autorizados, pero no son modulos principales
independientes ni deben aparecer como items nuevos del Sidebar.
...
- Internas o administracion: por ejemplo `/administrar-kpis`.
- Subflujos funcionales MVP: `/diagnostico`, `/health`, `/controles`, `/soa`,
  `/ciclo-vida`, `/auditorias`, `/hallazgos`, `/no-conformidades`,
  `/matriz-riesgo`, `/activos`, `/plan-accion` y
  `/acciones-recomendadas`; accesibles por tarjetas, sin entrada propia en
  Sidebar.
- Enterprise/post-MVP: rutas operativas detalladas no incluidas como subflujo
  funcional quedan marcadas como `enterprise_post_mvp` en la tabla.
