...
| `/auditor-iso` | `frontend/src/legacy-pages/auditor-iso/page.tsx` | legacy_candidate | No | Fuera del App Router | ai/audit | Redirect legacy desacoplado y cuarentenado; deep links usan `/cumplimiento-auditoria`. | Conservar temporalmente para rollback; evaluar borrado definitivo en etapa posterior. |
...
| `/centro-control-iso` | `frontend/src/legacy-pages/centro-control-iso/page.tsx` | legacy_candidate | No | Fuera del App Router | command-center | Redirect legacy desacoplado y cuarentenado; QA y demo usan `/dashboard`. | Conservar temporalmente para rollback; evaluar borrado definitivo en etapa posterior. |
...
| `/command-center-iso` | `frontend/src/legacy-pages/command-center-iso/page.tsx` | legacy_candidate | No | Fuera del App Router | command-center | Redirect legacy desacoplado y cuarentenado; QA y demo usan `/dashboard`. | Conservar temporalmente para rollback; evaluar borrado definitivo en etapa posterior. |
...
| `/dashboard-kpi` | `frontend/src/legacy-pages/dashboard-kpi/page.tsx` | duplicate_candidate | No | Fuera del App Router | dashboard/kpi | Redirect legacy desacoplado y cuarentenado; QA y demo usan `/dashboard`. | Conservar temporalmente para rollback; evaluar borrado definitivo en etapa posterior. |
