...
API_URL=http://bk.tcdx.int:3000 FRONTEND_URL=https://181.212.166.187:8443 EMAIL=admin@rieltec.com PASSWORD=123456 bash scripts/qa-security-basic.sh
API_URL=http://bk.tcdx.int:3000 FRONTEND_URL=https://181.212.166.187:8443 EMAIL=admin@rieltec.com PASSWORD=123456 bash scripts/qa-rbac-basic.sh
