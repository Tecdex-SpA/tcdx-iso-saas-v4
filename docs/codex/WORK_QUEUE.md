...
| PUI-06 | CODEX A | codex | READY | PUI-05 | - | FINAL_COMMIT_REPORTED_IN_CODEX_RESPONSE | - | docs/codex/handoffs/PUI-06.md | See Plan Maestro | Fallback legacy gobernado; ejecutar en nueva sesión/base actualizada |
