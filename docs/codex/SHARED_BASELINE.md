...
- Tenant Knowledge Ingestion v1 existe localmente: usar `knowledge_document_ingestions` para runs/idempotencia, `knowledge_document_chunks` para manifest determinístico sin embeddings y `knowledge_document_ingestion_audit` para auditoría sin texto completo/secretos.
