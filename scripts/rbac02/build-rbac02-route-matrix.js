...
const routeRules = [
  ...
  { routes: ['/auditorias/ia'], group: 'intelligence', feature: 'ai_compliance.read', permission: 'audit.review', capability: 'ai.auditor', module: 'ai_compliance', plan: 'AI_ADDON_REQUIRED', scope: 'tenant', roles: 'tenant_admin,auditor', expected: 'ALLOW_IF_AI_ADDON_ENTITLED' },
  ...
  { routes: ['/planes-accion', '/plan-accion', '/acciones-recomendadas'], group: 'audit-improvement', feature: 'action_plans.read', permission: 'actions.view', capability: 'iso.actions', module: 'iso', plan: 'ISO_OR_HIGHER', scope: 'tenant', roles: 'tenant_admin,auditor,area_owner,executive', expected: 'ALLOW_IF_ISO_ENTITLED' },
  ...
  { routes: ['/ia', '/ia-compliance'], group: 'intelligence', feature: 'ai_compliance.read', permission: 'ai.view', capability: 'ai.compliance', module: 'ai_compliance', plan: 'AI_ADDON_REQUIRED', scope: 'tenant', roles: 'tenant_admin,auditor', expected: 'ALLOW_IF_AI_ADDON_ENTITLED' },
  { routes: ['/ia-auditor'], group: 'intelligence', feature: 'ai_compliance.read', permission: 'audit.review', capability: 'ai.auditor', module: 'ai_compliance', plan: 'AI_ADDON_REQUIRED', scope: 'tenant', roles: 'tenant_admin,auditor', expected: 'ALLOW_IF_AI_ADDON_ENTITLED' },
