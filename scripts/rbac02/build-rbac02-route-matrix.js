...
const routeRules = [
  ...
  { routes: ['/grc-global'], group: 'operations-resilience', feature: 'phase2.read', permission: 'workflow.read', capability: 'grc.phase2', module: 'integrated_grc', plan: 'GRC_OR_EXPLICIT_MODULE', scope: 'tenant', roles: 'tenant_admin,auditor,area_owner', expected: 'ALLOW_IF_CONTRACTED_MODULE_ACTIVE' },
  { routes: ['/privacidad'], group: 'operations-resilience', feature: 'phase2.read', permission: 'privacy.read', capability: 'grc.phase2', module: 'integrated_grc', plan: 'GRC_OR_EXPLICIT_MODULE', scope: 'tenant', roles: 'tenant_admin,auditor,area_owner', expected: 'ALLOW_IF_CONTRACTED_MODULE_ACTIVE' },
  { routes: ['/incidentes'], group: 'operations-resilience', feature: 'phase2.read', permission: 'incidents.read', capability: 'grc.phase2', module: 'integrated_grc', plan: 'GRC_OR_EXPLICIT_MODULE', scope: 'tenant', roles: 'tenant_admin,auditor,area_owner', expected: 'ALLOW_IF_CONTRACTED_MODULE_ACTIVE' },
  { routes: ['/proveedores', '/portal-proveedor', '/conectores'], group: 'operations-resilience', feature: 'phase2.read', permission: 'workflow.read', capability: 'grc.phase2', module: 'integrated_grc', plan: 'GRC_OR_EXPLICIT_MODULE', scope: 'tenant', roles: 'tenant_admin,auditor,area_owner', expected: 'ALLOW_IF_CONTRACTED_MODULE_ACTIVE' },
  ...
  { routes: ['/grc', '/datos'], group: 'intelligence', feature: 'phase5.read', permission: 'data.catalog.read', capability: 'data.governance', module: 'data_governance', plan: 'GRC_OR_EXPLICIT_MODULE', scope: 'tenant', roles: 'tenant_admin,auditor,area_owner,executive', expected: 'ALLOW_IF_MODULE_ACTIVE' },
  { routes: ['/metricas', '/bi'], group: 'intelligence', feature: 'phase5.read', permission: 'metrics.read', capability: 'metrics.catalog', module: 'metrics_bi', plan: 'GRC_OR_EXPLICIT_MODULE', scope: 'tenant', roles: 'tenant_admin,auditor,area_owner,executive', expected: 'ALLOW_IF_MODULE_ACTIVE' },
  { routes: ['/encuestas', '/evaluaciones'], group: 'intelligence', feature: 'phase5.read', permission: 'surveys.read', capability: 'surveys.engine', module: 'surveys_assessments', plan: 'GRC_OR_EXPLICIT_MODULE', scope: 'tenant', roles: 'tenant_admin,auditor,area_owner', expected: 'ALLOW_IF_MODULE_ACTIVE' },
  { routes: ['/tests', '/eventos-perdida'], group: 'risk-control', feature: 'phase5.read', permission: 'loss_events.read', capability: 'loss.events', module: 'assurance_loss', plan: 'ISO_RIESGO_OPERATIVO_OR_GRC', scope: 'tenant', roles: 'tenant_admin,auditor,area_owner', expected: 'ALLOW_IF_MODULE_ACTIVE' },
  { routes: ['/reportes'], group: 'reports', feature: 'phase5.read', permission: 'reports.read', capability: 'reporting.studio', module: 'report_studio', plan: 'GRC_OR_EXPLICIT_MODULE', scope: 'tenant', roles: 'tenant_admin,auditor,executive', expected: 'ALLOW_IF_MODULE_ACTIVE' },
  { routes: ['/ia', '/ia-compliance'], group: 'intelligence', feature: 'ai_compliance.read', permission: 'ai_compliance.read', capability: 'ai.compliance', module: 'ai', plan: 'EXPLICIT_AI_ENTITLEMENT', scope: 'tenant', roles: 'tenant_admin,auditor', expected: 'ALLOW_IF_AI_ENTITLED' },
  { routes: ['/ia-auditor'], group: 'intelligence', feature: 'ai_compliance.read', permission: 'audit.review', capability: 'ai.auditor', module: 'ai', plan: 'EXPLICIT_AI_AUDITOR_ENTITLEMENT', scope: 'tenant', roles: 'tenant_admin,auditor', expected: 'ALLOW_IF_AI_AUDITOR_ENTITLED' },
