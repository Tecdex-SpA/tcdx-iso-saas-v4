...
WITH rows AS (
  ...
  FROM (VALUES
    ...
    ('procedimiento_acciones_correctivas', 'Procedimiento de Acciones Correctivas', 'procedure', 'docx', '01_DOCUMENTOS_VIGENTES_{{period_year}}/09_Acciones_Correctivas_y_Mejora_Continua_Jira', 'Define registro de no conformidades, causa raiz, acciones, cierre y eficacia.', 'hallazgos, no conformidades, Jira, responsables, plazos, evidencia de eficacia'),
    ('procedimiento_mejora_continua', 'Procedimiento de Mejora Continua', 'procedure', 'docx', '01_DOCUMENTOS_VIGENTES_{{period_year}}/09_Acciones_Correctivas_y_Mejora_Continua_Jira', 'Describe fuentes de mejora, priorizacion, seguimiento y verificacion.', 'KPIs, auditorias, hallazgos, satisfaccion, riesgos, acciones'),
    ...
    ('evidencias_jira', 'Indice de Evidencias Jira', 'evidence_index', 'md', '03_EVIDENCIAS_PARA_VALIDAR/01_Evidencias_Jira', 'Evidencias operativas provenientes de tickets o importaciones Jira.', 'tickets, incidencias, acciones, cierres, responsables'),
