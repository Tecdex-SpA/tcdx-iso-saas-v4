...
WITH rows AS (
  ...
  FROM (VALUES
    ...
    ('plan_tratamiento_riesgos_sgsi', 'Plan de Tratamiento de Riesgos SGSI', 'record', 'xlsx', '02_REGISTROS_DE_CONTROL_{{period_year}}', 'Registra tratamientos, responsables, plazos, estado y evidencia de mitigacion.', 'riesgos, controles, acciones, responsables, fechas, evidencia'),
    ('inventario_activos_sgsi', 'Inventario de Activos de Informacion', 'record', 'xlsx', '02_REGISTROS_DE_CONTROL_{{period_year}}', 'Lista activos de informacion, propietarios, criticidad, clasificacion y protecciones.', 'activos, propietarios, clasificacion, criticidad, controles'),
    ...
    ('procedimiento_continuidad_sgsi', 'Procedimiento de Continuidad y Respaldo SGSI', 'procedure', 'docx', '01_DOCUMENTOS_VIGENTES_{{period_year}}/03_Procedimientos_SGSI', 'Define continuidad, respaldo, recuperacion y pruebas asociadas al SGSI.', 'backups, continuidad, pruebas, responsables, evidencias'),
    ('procedimiento_proveedores_sgsi', 'Procedimiento de Seguridad para Proveedores', 'procedure', 'docx', '01_DOCUMENTOS_VIGENTES_{{period_year}}/03_Procedimientos_SGSI', 'Define requisitos de seguridad para proveedores, evaluacion, seguimiento y evidencia.', 'proveedores, contratos, SLA, evaluaciones, controles, evidencias'),
