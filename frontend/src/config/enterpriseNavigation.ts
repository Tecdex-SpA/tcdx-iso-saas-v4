...
export const CLIENT_ENTERPRISE_NAV_DOMAINS: EnterpriseNavDomain[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/riesgo-cuantitativo', label: 'Cuantitativo', labelKey: 'navigation.destinations.quantitativeRisk', feature: 'phase3.read', moduleKey: 'operations_grc' },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      { href: '/operaciones-grc', label: 'Riesgo Operativo', labelKey: 'navigation.destinations.grcOperations', feature: 'phase3.read', moduleKey: 'operations_grc' },
      { href: '/continuidad', label: 'Continuidad', labelKey: 'navigation.destinations.continuity', feature: 'phase3.read', moduleKey: 'operations_grc' },
      { href: '/incidentes', label: 'Incidentes', labelKey: 'navigation.destinations.incidents', feature: 'phase2.read', moduleKey: 'integrated_grc' },
      { href: '/proveedores', label: 'Proveedores', labelKey: 'navigation.destinations.suppliers', feature: 'phase2.read', moduleKey: 'integrated_grc' },
      { href: '/privacidad', label: 'Privacidad', labelKey: 'navigation.destinations.privacy', feature: 'phase2.read', moduleKey: 'integrated_grc' },
    ],
  },
  {
    id: 'data-evidence',
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/indicadores', label: 'Indicadores', labelKey: 'navigation.destinations.indicators', feature: 'phase3.read', moduleKey: 'operations_grc' },
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/conectores', label: 'Conectores', labelKey: 'navigation.destinations.connectors', feature: 'phase2.read', moduleKey: 'integrated_grc' },
    ],
  },
];
