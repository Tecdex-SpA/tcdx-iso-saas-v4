...
async function uploadSelectedTenantLogo(file: File) {
  ...
  async function saveTenantAiSettings() {
    ...
    try {
      ...
      setError('');
      await fetchJson(`/api/admin-saas/tenants/${selectedTenantId}/ai-settings`, {
        method: 'PUT',
        body: JSON.stringify({
          ...
          ai_monthly_quota: selectedAiDraft.ai_monthly_quota,
          ai_features_json: {
            company_profile_analysis: selectedAiDraft.ai_enabled,
            report_enrichment: selectedAiDraft.ai_report_enabled && selectedAiDraft.ai_enabled,
            auditor: selectedAiDraft.ai_auditor_enabled && selectedAiDraft.ai_enabled,
            web_research: selectedAiDraft.ai_web_enabled && selectedAiDraft.ai_enabled,
            document_generation: selectedAiDraft.ai_enabled,
            suggestions: selectedAiDraft.ai_enabled,
          },
        }),
      });
  ...
  const selectedAiDraft = aiSettingsDraftByTenant[selectedTenantId] || {
    ...
    ai_monthly_quota: selectedAiSource.ai_monthly_quota === null || selectedAiSource.ai_monthly_quota === undefined
      ? ''
      : String(selectedAiSource.ai_monthly_quota),
  };
