...
const EXACT_TEXT: Record<string, string> = {
  ...
  'Orquestación IA Tecdex GRC Compliance': 'Tecdex GRC Compliance AI Orchestration',
  ...
  'Base Tecdex GRC Compliance': 'Tecdex GRC Compliance Knowledge Base',
  'Motor IA Tecdex GRC Compliance': 'Tecdex GRC Compliance AI Engine',
  'Internet': 'Internet',
  'Benchmark': 'Benchmark',
  'Tenant': 'Tenant',
  'Abiertas': 'Open',
