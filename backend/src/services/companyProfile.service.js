...
async function analyzeCompanyProfile({ tenantId, userId = null, requestId = null, modelMode = 'balanced' }) {
  ...
  const trace = {
    ...
    tenant_id: tenantId,
    llm_trace: engine.llm_trace || null,
    llm_actor: engine.llm_actor || engine.llm_trace?.actor || null,
    llm_actor_type: engine.llm_actor_type || engine.llm_trace?.actor_type || null,
    llm_trace_system: engine.llm_trace_system || engine.llm_trace?.system || null,
    llm_trace_company: engine.llm_trace_company || engine.llm_trace?.company || null,
