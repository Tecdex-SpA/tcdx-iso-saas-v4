...
const CAPABILITIES = Object.freeze([
  ...
  capability('iso.actions', 'Planes de accion y acciones recomendadas de cumplimiento ISO', 'iso', 'iso_actions', CLASSIFICATIONS.ISO_ONLY, 'actions.view', ['/planes-accion', '/plan-accion', '/acciones-recomendadas'], ['/api/action-plans', '/api/iso-operational-execution', '/api/iso-recommended-actions']),
  ...
  capability('ai.compliance', 'IA Compliance transversal', 'ai_compliance', 'ai_compliance_core', CLASSIFICATIONS.AI_ADDON, 'ai.view', ['/ia', '/ia-compliance', '/ia-compliance/sugerencias'], ['/api/ai-compliance']),
