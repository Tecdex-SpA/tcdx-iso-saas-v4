...
function normalizeTenantDataset(rawDataset = {}) {
  return {
    ...
    soa_items: compactRows(rawDataset.soa_items || rawDataset.soa || rawDataset.applicable_controls),
    ...
    recent_nonconformities: compactRows(rawDataset.recent_nonconformities),
    ...
    knowledge_context: rawDataset.knowledge_context || {},
    regulatory_context: compactRows(rawDataset.regulatory_context),
    regulatory_packs: compactRows(rawDataset.regulatory_packs),
    pack_applicability: compactRows(rawDataset.pack_applicability),
    historical_context: compactRows(rawDataset.historical_context, 120),
