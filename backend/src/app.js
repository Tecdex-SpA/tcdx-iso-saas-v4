...
const { tenantContextMiddleware } = require('./utils/dbTenantContext');
...
const adminSaasCommercialRoutes = require('./routes/admin-saas-commercial.routes');
...
app.get('/metrics', (_req, res) => {
  ...
  res.type('text/plain; version=0.0.4').send([
    ...
    '# HELP tcdx_grc_phase1_operation_errors_total Total failed Phase 1 GRC operations.',
    '# TYPE tcdx_grc_phase1_operation_errors_total counter',
    '# HELP tcdx_grc_phase1_scheduler_runs_total Total Phase 1 scheduler executions.',
    '# TYPE tcdx_grc_phase1_scheduler_runs_total counter',
    '# HELP tcdx_grc_phase1_scheduler_retries_total Total Phase 1 scheduler retries.',
    '# TYPE tcdx_grc_phase1_scheduler_retries_total counter',
    '# HELP tcdx_grc_phase1_escalations_total Total Phase 1 escalation evaluations.',
    '# TYPE tcdx_grc_phase1_escalations_total counter',
    '# HELP tcdx_grc_phase1_exports_total Total Phase 1 exports.',
    '# TYPE tcdx_grc_phase1_exports_total counter',
...
app.use('/api/ai-auditor', requireCommercialCapability('ai.auditor', { requiredPermission: 'audit.review' }), aiAuditorRoutes);
...
app.use('/api/admin-saas', adminSaasCommercialRoutes);
